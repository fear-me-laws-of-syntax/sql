...
SELECT 
    v.vendor_name,
    p.product_name,
    COUNT(c.customer_id) * 5 * v.price AS total_earnings
FROM 
    (SELECT DISTINCT vendor_name, product_id, price FROM vendor_inventory) v
CROSS JOIN 
...
VALUES
(100, 'Apple Pie', '10', 3, 'unit', CURRENT_TIMESTAMP);
